(function () {
    ...
    module.controller("RouteEditCtrl", RouteEditCtrl);
    RouteEditCtrl.$inject = ['$scope', 'RouteService', 'VesselService', 'ScheduleService', 'VesselInformation'];

    function RouteEditCtrl($scope, RouteService, VesselService, ScheduleService, VesselInformation) {
    ...
    module.controller("RouteEditFormCtrl", RouteEditFormCtrl);
    RouteEditFormCtrl.$inject = ['$scope'];

    function RouteEditFormCtrl($scope) {
        $scope.saveable = function () {
            ...
            return $scope.waypoints && $scope.waypoints.length >= 3;
        };
    }
}());
