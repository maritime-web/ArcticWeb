(function () {
    ...
    module.controller('RouteUploadCtrl', RouteUploadCtrl);
    RouteUploadCtrl.$inject = ['$scope', 'VesselService', 'ScheduleService', 'VesselInformation', '$timeout'];

    function RouteUploadCtrl($scope, VesselService, ScheduleService, VesselInformation, $timeout) {
        function initUpload() {
