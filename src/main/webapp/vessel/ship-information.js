(function () {
    ...
    module.controller('VesselInformationEditCtrl', VesselInformationEditCtrl);
    VesselInformationEditCtrl.$inject = ['$scope', 'VesselService', 'VesselInformation'];

    function VesselInformationEditCtrl($scope, VesselService, VesselInformation) {
    ...
    module.controller('VesselInformationViewCtrl', VesselInformationViewCtrl);
    VesselInformationViewCtrl.$inject = ['$scope', 'VesselService', 'VesselInformation'];

    function VesselInformationViewCtrl($scope, VesselService, VesselInformation) {
        $scope.provider = {
            title: "Vessel Information",
            type: "view",
            doShow: false,
