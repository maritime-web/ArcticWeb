$(function() {
    ...
    module.controller("YourVesselControl", [ '$scope', 'VesselService', 'Subject', 'VesselInformation', 'SubscriptionService', 'VesselServiceFactory',
        function ($scope, VesselService, Subject, VesselInformation, SubscriptionService, VesselServiceFactory) {
